...
\begin{document}
  ...
  \faIcon{linkedin} \hspace{1ex} \href{https://www.linkedin.com/in/omar-mesquita/}{Omar Mesquita}


  \faIcon{github}	\hspace{1ex} \href{https://github.com/OmarMesqq}{OmarMesqq}
  
 
  \faIcon{envelope} \hspace{1ex} \href{mailto:omarmesquita@eq.ufrj.br}{omarmesquita@eq.ufrj.br}
