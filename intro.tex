...
\fancyhead[C]{\hrulefill\ Introdução ao Linux e ao Python \hrulefill} 
...
\begin{document}
	...
	como o fato de ser código aberto. No entanto, para fins desse livreto, ele se resume à agilidade
	...
	O que significa que a pessoa de nome \texttt{user} está, ou "at" em inglês, (\texttt{@}) no computador de nome
